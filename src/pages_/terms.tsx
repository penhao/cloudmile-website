                                ...
                                <ul>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist1")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist2")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist3")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist4")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist5")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist6")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist7")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist8")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist9")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist10")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist11")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist12")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist13")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist14")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist15")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist16")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list4.sublist17")}
                                        </Typography>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            ...
                            <div>
                                <ul>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list7.sublist1")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list7.sublist2")}
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography variant={"body1"}>
                                            {t("terms:list7.sublist3")}
                                        </Typography>
                                    </li>
                                </ul>
                            </div>
