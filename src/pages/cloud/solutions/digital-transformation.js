...
import C from '../../../../src/pages_/cloud/solutions/digital-transformation'
...
const ns2 = await import(`../../../../locales/${_lang}/digital-transformation`).then(m => m.default)
const ns3 = await import(`../../../../locales/${_lang}/case-study`).then(m => m.default)
  const _ns = { 'common': ns0, 'form': ns1, 'digital-transformation': ns2, 'case-study': ns3 }
