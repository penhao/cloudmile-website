...
import C from '../../../../src/pages_/cloud/solutions/data-driven-business'
...
const ns2 = await import(`../../../../locales/${_lang}/data-driven-business`).then(m => m.default)
const ns3 = await import(`../../../../locales/${_lang}/case-study`).then(m => m.default)
  const _ns = { 'common': ns0, 'form': ns1, 'data-driven-business': ns2, 'case-study': ns3 }
