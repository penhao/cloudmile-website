...
import C, * as _rest from '../../../../src/pages_/cloud/solutions/google-workspace'
...
const ns2 = await import(`../../../../locales/${_lang}/google-workspace`).then(m => m.default)
  const _ns = { 'common': ns0, 'form': ns1, 'google-workspace': ns2 }
