...
import C from '../../../../src/pages_/cloud/solutions/it-modernization'
...
const ns2 = await import(`../../../../locales/${_lang}/it-modernization`).then(m => m.default)
const ns3 = await import(`../../../../locales/${_lang}/case-study`).then(m => m.default)
  const _ns = { 'common': ns0, 'form': ns1, 'it-modernization': ns2, 'case-study': ns3 }
