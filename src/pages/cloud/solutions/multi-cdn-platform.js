...
import C from '../../../../src/pages_/cloud/solutions/multi-cdn-platform'
...
const ns2 = await import(`../../../../locales/${_lang}/multi-cdn-platform`).then(m => m.default)
  const _ns = { 'common': ns0, 'form': ns1, 'multi-cdn-platform': ns2 }
