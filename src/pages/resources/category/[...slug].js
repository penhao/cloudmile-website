...
import C, * as _rest from '../../../../src/pages_/resources/category/[...slug]'
...
const ns2 = await import(`../../../../locales/${_lang}/category`).then(m => m.default)
  const _ns = { 'common': ns0, 'form': ns1, 'category': ns2 }
