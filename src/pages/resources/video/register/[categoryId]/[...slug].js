...
import C, * as _rest from '../../../../../../src/pages_/resources/video/register/[categoryId]/[...slug]'
...
const ns2 = await import(`../../../../../../locales/${_lang}/video`).then(m => m.default)
  const _ns = { 'common': ns0, 'form': ns1, 'video': ns2 }
