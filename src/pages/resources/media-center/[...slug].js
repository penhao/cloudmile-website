...
import C, * as _rest from '../../../../src/pages_/resources/media-center/[...slug]'
...
const ns2 = await import(`../../../../locales/${_lang}/media-center`).then(m => m.default)
  const _ns = { 'common': ns0, 'form': ns1, 'media-center': ns2 }
