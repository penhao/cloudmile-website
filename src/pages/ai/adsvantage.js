...
import C, * as _rest from '../../../src/pages_/ai/adsvantage'
...
const ns2 = await import(`../../../locales/${_lang}/adsvantage`).then(m => m.default)
  const _ns = { 'common': ns0, 'form': ns1, 'adsvantage': ns2 }
