...
import C from '../../../src/pages_/ai/artificial-intelligence-services'
...
const ns2 = await import(`../../../locales/${_lang}/ai-services`).then(m => m.default)
const ns3 = await import(`../../../locales/${_lang}/case-study`).then(m => m.default)
  const _ns = { 'common': ns0, 'form': ns1, 'ai-services': ns2, 'case-study': ns3 }
