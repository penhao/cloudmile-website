...
const currentDomain: string = process.env.API_BASE_PATH;
...
export const fetchListByTag = async (
    lang: string,
    pageId: number,
    tagId: number,
    startCount: number,
    ...
    const response: any = await get(
        `${currentDomain}/api/SearchArticleTag`,
        requestConfig
    );
    return response.status ? response.data : response;
};

export const fetchMediaCenterList = async (
    lang: string,
    startCount: number,
    limit: number
) => {
...
export const fetchMediaCenterArticle = async (
    lang: string,
    articleId: number | string
) => {
    const requestConfig: AxiosRequestConfig = {
...
export const fetchCaseList = async (
    ...
    const response: any = await get(
        `${currentDomain}/api/cases`,
        requestConfig
    );
    return response.data;
};
export const fetchCaseArticle = async (
    lang: string,
    articleId: number | string
) => {
    const requestConfig: AxiosRequestConfig = {
...
export const fetchEventList = async (
    ...
    const response: any = await get(
        `${currentDomain}/api/Event`,
        requestConfig
    );
    return response.data;
};
export const fetchEventArticle = async (
    lang: string,
    articleId: number | string
) => {
    const requestConfig: AxiosRequestConfig = {
...
export const fetchVideoCategoryList = async (lang: string) => {
    ...
    const response: any = await get(
        `${currentDomain}/api/VideoCategory`,
        requestConfig
    );
    return response.data;
};
...
export const fetchVideoList = async (
    ...
    const response: any = await get(
        `${currentDomain}/api/Video`,
        requestConfig
    );
    return response.data;
};
export const fetchVideoArticle = async (
    lang: string,
    articleId: number | string
) => {
    const requestConfig: AxiosRequestConfig = {
...
/* Preview */
export const fetchPreviewBlogArticle = async (
    lang: string,
    articleId: number | string
) => {
    const requestConfig: AxiosRequestConfig = {
...
export const fetchPreviewMediaCenterArticle = async (
    lang: string,
    articleId: number | string
) => {
    const requestConfig: AxiosRequestConfig = {
...
export const fetchPreviewCaseArticle = async (
    lang: string,
    articleId: number | string
) => {
    const requestConfig: AxiosRequestConfig = {
...
export const fetchPreviewEventArticle = async (
    lang: string,
    articleId: number | string
) => {
    const requestConfig: AxiosRequestConfig = {
...
export const fetchPreviewVideoArticle = async (
    lang: string,
    articleId: number | string
) => {
    const requestConfig: AxiosRequestConfig = {
